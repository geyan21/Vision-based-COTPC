...
from data_modified import MS2Demos, get_padding_fn
...
def parse_args():
    ...
    parser.add_argument("--n_embd", default=2112, type=int, help="Hidden feature dimension.")
...
if __name__ == "__main__":
    ...
    if args.from_ckpt > 0:  
        ...
        pretrained_model = torch.load(path)['model']
